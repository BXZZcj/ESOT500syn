...
def main():
    ...
    parser.add_argument("--configs_dir", type=str, default="/home/chujie/Data/ESOT500syn/test/output/ESOT500syn_dataset", help="Root directory containing the generated config folders.")
